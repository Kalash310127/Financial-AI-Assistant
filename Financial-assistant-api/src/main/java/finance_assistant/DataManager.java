...
public class DataManager {
    ...
    private Map<String, Object> parseData() {
        ...
        data.put("stocks", rawData.optJSONArray("stocks"));
        data.put("insurance_policies", rawData.optJSONArray("insurance_policies"));
        data.put("recurring_bills", rawData.optJSONArray("recurring_bills"));
        data.put("financial_goals", rawData.optJSONArray("financial_goals"));
        return data;
    }
    ...
    private Map<String, Boolean> getInitialPermissions() {
        ...
        initialPermissions.put("stocks", true);
        initialPermissions.put("insurance_policies", true);
        initialPermissions.put("recurring_bills", true);
        initialPermissions.put("financial_goals", true);
